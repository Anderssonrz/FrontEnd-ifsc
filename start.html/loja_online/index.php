    ...
    <header class="bg-dark py-5">
        <div class="container px-4 px-lg-5 my-5">
            <div class="text-center text-white">
                <h1 class="display-4 fw-bolder">Loja de Eletrônica</h1>
                <p class="lead fw-normal text-white-50 mb-0">todos os produtos que você precisa</p>
            </div>
        </div>
    </header>
                        ...
                        <div class="card h-100">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"><?php echo $linha['nome']; ?></h5>
                                    <!-- Product price-->

                                    <span class="text-muted text-decoration-line-through">R$<?php echo $linha['preco']; ?></span>
                                    R$<?php echo $linha['desconto_usados']; ?>
                                </div>
                            </div>
                            <!-- Product actions-->
